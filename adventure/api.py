...
def initialize(request):
    ...
    return JsonResponse({'uuid': uuid, 'name':player.user.username, 'id':room.id, 'title':room.title, 'description':room.description, 'x': x, 'y': y, 'players':players, 'map': map()}, safe=True)
